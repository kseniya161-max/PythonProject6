...
if __name__ == "__main__":
    transactions = [
        {"Категории": "Переводы", "Описание": "Валерий А.", "Количество": 1000},
        {"Категории": "Покупки", "Описание": "Роман В.", "Количество": 500},
        {"Категории": "Переводы", "Описание": "Сергей З.", "Количество": 500},
        {"Категории": "Покупки", "Описание": "Артем П.", "Количество": 1500}
    ]
